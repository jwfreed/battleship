...
export function CrosshairsIcon({ size = 20, color = 'currentColor', className = '' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function AnchorIcon({ size = 20, color = 'currentColor', className = '' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function RadarIcon({ size = 20, color = 'currentColor', className = '' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function FleetIcon({ size = 20, color = 'currentColor', className = '' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function ExitIcon({ size = 20, color = 'currentColor', className = '' }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
